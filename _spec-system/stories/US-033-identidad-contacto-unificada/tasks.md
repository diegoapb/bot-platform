...
- [ ] **T1 — Migración: tabla `contacts` + `contact_id` en links y memoria**
...
- [ ] **T3 — `contactResolver`: resolución idempotente + unificación + sin-identificador**
...
- [ ] **T4 — Integrar resolución de contacto en `channel-inbound`**
...
- [ ] **T5 — Conmutar memoria/facts/extracción a `contact_id`**
...
- [ ] **T6 — Backfill idempotente (1 contacto por `channel_link`)**

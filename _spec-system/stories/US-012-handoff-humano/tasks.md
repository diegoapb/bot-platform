...
- [ ] **T1 — Migración: `conversation_transitions` + `bots.handoff_message`**
...
- [ ] **T2 — `conversationState.setMode` transaccional e idempotente**
...
- [ ] **T3 — Tool `request_human` en replyEngine**
...
- [ ] **T4 — Endpoint de modo + webhook `conversation_updated`**
...
- [ ] **T5 — UI de estado en panel de conversación**

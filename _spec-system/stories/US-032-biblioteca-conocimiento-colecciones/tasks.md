...
- [ ] **T1 — Migración de esquema: `knowledge_collections`, `agent_knowledge_collections` y `collection_id`**
...
- [ ] **T2 — `collectionsService`: CRUD + enlace/desenlace + colecciones por agente**
...
- [ ] **T3 — `knowledgeService` ingestión por colección (createSource/reindex/deleteSource/listSources)**
...
- [ ] **T4 — `retrieve(agentId, query, k)` multi-colección con aislamiento**
  - Archivos: `apps/backend/src/services/knowledge.ts`
...
- [ ] **T5 — Endpoints de colecciones, fuentes y enlaces**
...
- [ ] **T6 — Migración de datos idempotente bot→colección**
...
- [ ] **T7 — Reapuntar el motor a `retrieve(agentId, …)`**

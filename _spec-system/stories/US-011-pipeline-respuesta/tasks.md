...
- [x] **T1 — Migración: `conversations` y `generations`**
...
- [x] **T2 — `llm` client (Anthropic, tool-use, timeout)**
...
- [x] **T4 — `replyEngine`: debounce, lock, envío y registro**
...
- [x] **T5 — Integración con `messageSync` (US-007)**

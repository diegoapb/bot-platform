...
**Progreso:** 0/5 en producción (0%) · Pendiente de pruebas: 5

| ID | Título | Ciclo | Estado | Prioridad |
| --- | --- | --- | --- | --- |
| [US-030](../stories/US-030-entidad-agente-migracion/index.md) | Entidad Agente y migracion bot->agente | — | Pendiente de pruebas | P0 |
| [US-031](../stories/US-031-asignacion-canal-agente-ruteo/index.md) | Asignación N:M canal-agente y ruteo de inbound por agente | — | Pendiente de pruebas | P0 |
| [US-032](../stories/US-032-biblioteca-conocimiento-colecciones/index.md) | Biblioteca de conocimiento reutilizable y enlace a agentes | — | Pendiente de pruebas | P0 |
| [US-033](../stories/US-033-identidad-contacto-unificada/index.md) | Identidad de contacto unificada entre canales | — | Pendiente de pruebas | P1 |
| [US-034](../stories/US-034-ui-gestion-agentes/index.md) | UI de gestion de agentes | — | Pendiente de pruebas | P1 |
